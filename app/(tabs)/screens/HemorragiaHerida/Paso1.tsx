...
import multi from "../../../../assets/images/Hemorragiaspaso1.gif";
...
export default function TabTwoScreen() {
 ...
 useEffect(() => {if(time === 0){
   navigation.push('/(tabs)/screens/HemorragiaHerida/Paso2')
 }}, [time] )
   useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
         <Link style={{ fontSize: 18 }} href={'/(tabs)/screens/HemorragiaHerida/Paso2'}>Saltar {">>"}</Link>
