...
import multi from "../../../../assets/images/Extintorpaso2.gif";
...
export default function TabTwoScreen() {
 ...
 useEffect(() => {if(time === 0){
   navigation.push('/(tabs)/screens/Incendios/Paso3')
 }}, [time] )
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
          <Link style={{ fontSize: 18 }} href={'/(tabs)/screens/Incendios/Paso3'}>Saltar {">>"}</Link>
