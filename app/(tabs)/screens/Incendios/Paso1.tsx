...
import multi from "../../../../assets/images/Extintorpaso1.gif";
...
export default function TabTwoScreen() {
 ...
 useEffect(() => {if(time === 0){
   navigation.push('/(tabs)/screens/Incendios/Paso2')
 }}, [time] )
    ...
    <View style={styles.container}>
     ...
     suficiente presión para apagar el fuego.{" "}
      ...
      >
        ...
        >
          <Link style={{ fontSize: 18 }}  href={'/(tabs)/screens/Incendios/Paso2'}>Saltar {">>"}</Link>
