...
import multi from "../../../../assets/images/torniquete3.gif";
     ...
     return (
       <View style={styles.container}>
         ...
         <Text style={{ fontSize: 15, marginTop: 80, width: "80%" , textAlign: "justify"}}>
           Haga un nudo.
           Ponga un objeto en forma sobre el nudo.
           Sujete con un nudo fuerte y gire la barra hasta detener el sangrado{" "}
         </Text>
         <View
           style={{
             width: "90%",
